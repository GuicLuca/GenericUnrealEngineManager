...
const defaultSettings: AppSettings = {
  ...
  compression: {
    ...
    custom_presets: {
      ...
      'Archive Style': '[YYYY]-[MM]-[DD]_[Project]',
      'User Specific': '[User]_[Computer]_[Project]_[Mon][DD]_[HH][mm]',
      'Timestamp': '[Project]_[Timestamp]',
      'Engine Specific': 'UE[Engine]_[Project]_[Type]_[YYYY][MM][DD]'
    }
  }
}
  ...
  const loadSettings = async (): Promise<void> => {
    try {
      ...
      Object.assign(settings, {
        ...
        ide_programs: { ...defaultSettings.ide_programs, ...backendSettings.ide_programs },
        engine_programs: { ...defaultSettings.engine_programs, ...backendSettings.engine_programs },
        cleaning_defaults: { ...defaultSettings.cleaning_defaults, ...backendSettings.cleaning_defaults },
        general: { ...defaultSettings.general, ...backendSettings.general },
        compression: { 
          ...defaultSettings.compression, 
          ...backendSettings.compression,
          custom_presets: { ...defaultSettings.compression.custom_presets, ...backendSettings.compression.custom_presets }
        }
      })
